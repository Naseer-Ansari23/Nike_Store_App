...
class KidsShoes_Page extends StatefulWidget {
  const KidsShoes_Page({Key? key}) : super(key: key);

  @override
  State<KidsShoes_Page> createState() => _KidsShoes_PageState();
}

class _KidsShoes_PageState extends State<KidsShoes_Page> {

  CollectionReference reference= FirebaseFirestore.instance.collection('Kids');
