...
class WomenShoes_Page extends StatefulWidget {
  const WomenShoes_Page({Key? key}) : super(key: key);

  @override
  State<WomenShoes_Page> createState() => _WomenShoes_PageState();
}

class _WomenShoes_PageState extends State<WomenShoes_Page> {

  CollectionReference reference= FirebaseFirestore.instance.collection('Women');
