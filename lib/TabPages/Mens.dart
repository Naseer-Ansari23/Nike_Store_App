...
import 'package:nike_app/Pages/Detail_Page.dart';

class MensShoes_Page extends StatefulWidget {
  const MensShoes_Page({Key? key}) : super(key: key);

  @override
  State<MensShoes_Page> createState() => _MensShoes_PageState();
}

class _MensShoes_PageState extends State<MensShoes_Page> {

  CollectionReference reference= FirebaseFirestore.instance.collection('Mens');
