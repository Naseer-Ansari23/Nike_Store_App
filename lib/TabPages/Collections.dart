...
class Collections_Page extends StatefulWidget {
  const Collections_Page({Key? key}) : super(key: key);

  @override
  State<Collections_Page> createState() => _Collections_PageState();
}

class _Collections_PageState extends State<Collections_Page> {
